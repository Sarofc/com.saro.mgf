...
namespace Saro.SEditor
{
    ...
    public class FilterWindow : EditorWindow
    {
        ...
        private bool m_HasSearch { get { return !string.IsNullOrEmpty(m_Search); } }

        private GroupElement m_ActiveParent { get { return m_Stack[m_Stack.Count - 2 + m_AnimTarget]; } }

        private Element[] m_ActiveTree { get { return m_HasSearch ? m_SearchResultTree : m_Tree; } }
        ...
        private bool m_IsAnimating { get { return !Mathf.Approximately(m_Anim, m_AnimTarget); } }
