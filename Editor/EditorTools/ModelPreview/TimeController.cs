...
namespace Saro.SaroEditor
{
    public class TimeController
    {
        ...
        public bool playing
        {
            ...
            set
            {
                if (m_Playing != value)
                {
                    ...
                    if (value)
                    {
                        EditorApplication.update += RepaintAllInspectors;
        ...
        private MethodInfo m_repaintAllInspectors;
        private MethodInfo m_drawPlayhead;
        ...
        public TimeController()
        {
            ...
            m_repaintAllInspectors = assembly.GetType("UnityEditor.InspectorWindow").GetMethod("RepaintAllInspectors", BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic);
            m_drawPlayhead = assembly.GetType("UnityEditor.TimeArea").GetMethod("DrawPlayhead", BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic);
        }
        ...
        public void DoTimeControl(Rect rect)
        {
            ...
            m_drawPlayhead.Invoke(null, new object[] { normalizedPosition, scrubberRect.yMin, scrubberRect.yMax, 2f, (EditorGUIUtility.keyboardControl == id) ? 1f : 0.5f });
        }
